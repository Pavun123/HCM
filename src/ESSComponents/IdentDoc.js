        ...
        <div className="header-flex">
          ...
          <div className="dropdown mobile-actions">
            ...
            <ul className="dropdown-menu dropdown-menu-end text-center">
              ...
              {saveButtonVisible && ['add', 'all permission'].some(p => identityPermissions.includes(p)) && (
        ...
        <div className="row g-3">
          ...
          <div className="col-md-3">
            <div className="inputGroup">
              ...
              <span className="select-add-btn" title="Identity Documents Help" onClick={handleIdentDet}>
            ...
            <div key={index} className="row g-3">
              ...
              ${member.selectDocumentType ? "has-value" : ""} 
               ${isSelectDocument[index] ? "is-focused" : ""}`}
                >
                  ...
                  />
                  <label htmlFor={`cname-${index}`} className={`floating-label ${error && !member.documentType ? 'text-danger' : ''}`}>
              ...
              <div className="col-md-2">
                <div className="inputGroup">
                  ...
                  />
                  <label htmlFor={`add1-${index}`} className={`exp-form-labels ${error && !member.documentNo ? 'text-danger' : ''}`}>
              ...
              <div className="col-md-2">
                <div className="inputGroup">
                  <input
                    ...
                    required
                  />
                  <label htmlFor={`add1-${index}`} className={`exp-form-labels ${error && !member.issueDate ? 'text-danger' : ''}`}>
              ...
              <div className="col-md-2">
                <div className="inputGroup">
                  <input
                    ...
                    placeholder=" "
                  />
                  <label htmlFor={`add2-${index}`} className={`exp-form-labels ${error && !member.expiryDate ? 'text-danger' : ''}`}>
